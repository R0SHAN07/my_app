...
class Atri:
	def __init__(self, state: Any):
		...
		self.RestaurentX = state["RestaurentX"]
	...
	@property
	def RestaurentX(self):
		self._getter_access_tracker["RestaurentX"] = {}
		return self._RestaurentX
	@RestaurentX.setter
	def RestaurentX(self, new_state):
		self._setter_access_tracker["RestaurentX"] = {}
		global default_state
		self._RestaurentX = Image(new_state, default_state["RestaurentX"])
